...
@section('title', 'Store New Player')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name text-capitalize">Name</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="pt-5">
                                        <textarea name="description" id="description" class="form-control border-input">{{ old('description') }}</textarea>
